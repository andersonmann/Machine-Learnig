...
public class ExtratorCaracteristicas {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < arquivos.length; i++) {
			...
			// Imagem processada - tamanho, profundidade de cores e número de
			// canais de cores
			...
			// Imagem processada de acordo com as características (alteração
			// das cores)
			imagemProcessada = new IplImage(mtx);

			// Normaliza as características pelo número de pixels totais da
			// imagem
			...
			System.out.println("Laranja camisa Bart: " + caracteristicas[i][0] + " - Azul cal��o Bart: "
					+ caracteristicas[i][1] + " - Azul sapato Bart: " + caracteristicas[i][2] + " - Azul cal�a Homer: "
